...
public interface MessageConstants {
    ...
    TranslatableComponent.Builder COMMAND_ENTITY_NOTFOUND_ENTITY = Component.translatable().key("command.entity.notfound.entity");
    TranslatableComponent.Builder COMMAND_ENTITY_NOTFOUND_PLAYER = Component.translatable().key("command.entity.notfound.player");
